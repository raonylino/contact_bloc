...
mixin _$ContactUpdateEvent {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(String name, String email, int id) save,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(String name, String email, int id)? save,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class $ContactUpdateEventCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String email, int id});
}
...
class _$SaveImpl implements _Save {
  const _$SaveImpl({required this.name, required this.email, required this.id});
  ...
  @override
  String toString() {
    return 'ContactUpdateEvent.save(name: $name, email: $email, id: $id)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return save?.call(name, email, id);
  }
...
abstract class _Save implements ContactUpdateEvent {
  const factory _Save(
      ...
      required final int id}) = _$SaveImpl;
